...
public class EmployeeJDBCInsertExample {
	...
	public static void main(String[] args) {
		...
		try {
			...
			insertEmployeeData(con, 1, "Rajesh");

			insertAddressData(con, 1, "Albany Dr", "berkley", "USA");
	...
	protected static void insertAddressData(Connection con, int id, String address, String city, String country)
			throws SQLException {
	...
	protected  static void insertEmployeeData(Connection con, int id, String name)throws SQLException {
