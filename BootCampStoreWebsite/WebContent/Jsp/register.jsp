...
<body>
	...
	<div class="top">
		<ul>
			...
			<li><a href="Jspfiles/Books.jsp">Books</a></li>
			<li><a href="Jspfiles/computers.jsp">Computers</a></li>
			<li><a href="Jspfiles/phone.jsp">Phones</a></li>
		</ul>
	</div>
	<div class="mid">
		...
		<%  if(null!=request.getAttribute("errorMessage"))
			...
			<form action="<%=request.getContextPath()%>/register1" method="post">
				<p><input type="text" size="12" name="firstname" placeholder="First" required>
				<input type="text" size="12" name="lastname" placeholder="Last" required><br>	
				<input type="text" size="12"  name="username" placeholder="User Name" required >
				<input type="password" size="12"  name="password" placeholder="Password" required></p>	
				<p> Birth Date<br>
				...
				<p>Phone number <br>
				<input type="text" name="phone"size="29"  placeholder="(XXX)XXX-XXXX" ></p>
				Comment:<br>
				<textarea rows="4" cols="31" name="comment"></textarea><br>
				<br><input class="submit_button" type="submit"value="Create Account"></br>
			<br>
			<br>
		</form>
	</div>
